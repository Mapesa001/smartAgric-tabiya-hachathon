...
const App = () => {
  ...
  const languageOptions = [
    { label: 'English', value: 'en' },      // Widely used as a global lingua franca
    { label: 'French', value: 'fr' },       // Spoken in some East African countries like Rwanda and Burundi
    { label: 'Swahili', value: 'sw' },      // Widely spoken in Kenya, Tanzania, and Uganda
    { label: 'Amharic', value: 'am' },      // Official language of Ethiopia
    { label: 'Somali', value: 'so' },       // Spoken in Somalia and parts of Kenya and Ethiopia
    { label: 'Oromo', value: 'om' },        // Spoken in Ethiopia and parts of Kenya
    { label: 'Tigrinya', value: 'ti' },     // Spoken in Eritrea and northern Ethiopia
    { label: 'Luo', value: 'luo' },          // Spoken in Kenya, primarily among the Luo people
    { label: 'Kikuyu', value: 'ki' },        // Spoken by the Kikuyu people in Kenya
    { label: 'Rwandan', value: 'rw' }        // Also known as Kinyarwanda, spoken in Rwanda
];
...
const handleMicClick = () => {
  // Check if already listening; if so, stop listening
  if (isListening) {
...
const speakMessage = () => {
  ...
  utterance.onend = () => {
    ...
    setText(''); // Optional: Reset text if needed
  };
