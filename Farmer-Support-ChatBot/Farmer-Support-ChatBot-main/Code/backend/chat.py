...
from deep_translator import GoogleTranslator  # Use deep-translator instead of the previous translator
from flask import Flask
from flask_socketio import SocketIO, emit

# Initialize lemmatizer and load model files
...
# Function to translate messages using deep-translator
def translate_message(message, source_language, target_language='en'):
    try:
        ...
        return message  # Return the original message in case of error
